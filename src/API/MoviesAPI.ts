...
export const MoviesAPI = [
  ...
  },
  {
    ...
    country: "აშშ",
    description:
      "While looking for a home, the Croods stumble into the walled land owned by the Betterman family. They are looked down upon by the technologically advanced Bettermans but help them during a crisis.",
    imdb: 6.9,
  },
  {
    id: 10,
